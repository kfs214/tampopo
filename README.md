...
```bash
tampopo$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
tampopo$ sam logs -n HelloWorldFunction --stack-name tampopo --tail
```
